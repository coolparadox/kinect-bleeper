...
static char doc[] = "kinect_bleeper -- obstacle avoidance using sounds and "
	...
	"\nThe horizontal position of the nearest object is encoded by the "
	"left-right audio balance of speakers, the vertical position is encoded "
	"by the tone of bleeps, and the distance to the nearest object is encoded "
